...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displaySummaryAnswers() {
      ...
      var answersContainer6 = document.getElementById('ans6');
      var answersContainer7 = document.getElementById('ans7');
      ...
      // Retrieve and display answers for Part 3
      var storedAnswersPart3 = localStorage.getItem('answersPart3');
      if (storedAnswersPart3 && answersContainer6 && answersContainer7) {
        var answersPart3 = JSON.parse(storedAnswersPart3);
        answersContainer6.innerHTML = answersPart3.answ6;
        answersContainer7.innerHTML = answersPart3.answ7;
      }
    }
  ...
  function saveAnswersPart3() {
    var answers = {
      answ6: document.getElementById('ans6').value,
      answ7: document.getElementById('ans7').value,
    };
    localStorage.setItem('answersPart3', JSON.stringify(answers));
  }
  ...
  function saveCopy() {
    ...
    if (storedAnswersPart1 && storedAnswersPart2  && storedAnswersPart3) {
      var combinedAnswers = {
        part1: JSON.parse(storedAnswersPart1),
        part2: JSON.parse(storedAnswersPart2),
        part3: JSON.parse(storedAnswersPart3)
  ...
  function analyzeAnswers() {
    var answers = {
      ...
      "answ6": document.getElementById('ans6').textContent.trim(),
      "answ7": document.getElementById('ans7').textContent.trim(),
